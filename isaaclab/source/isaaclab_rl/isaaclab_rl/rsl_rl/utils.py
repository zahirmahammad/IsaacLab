...
if TYPE_CHECKING:
    from isaaclab.source.isaaclab_rl.isaaclab_rl.rsl_rl import RslRlBaseRunnerCfg
...
def handle_deprecated_rsl_rl_cfg(agent_cfg: RslRlBaseRunnerCfg, installed_version) -> RslRlBaseRunnerCfg:
    ...
    if installed_version < _V4_0_0:
        ...
        from isaaclab.source.isaaclab_rl.isaaclab_rl.rsl_rl import RslRlPpoAlgorithmCfg
    ...
    # Handle configurations for rsl-rl >= 4.0.0
        ...
        if installed_version < _V5_0_0:
            ...
            from isaaclab.source.isaaclab_rl.isaaclab_rl.rsl_rl import RslRlMLPModelCfg
