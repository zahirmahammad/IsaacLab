...
from isaaclab.source.isaaclab.isaaclab.utils.string import resolve_matching_names_values
    ...
    def compute(
        ...
        try:
            ...
            if self.cfg.xr_enabled:
                from isaaclab.source.isaaclab.isaaclab.ui.xr_widgets import XRVisualization
