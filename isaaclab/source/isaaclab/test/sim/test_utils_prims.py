...
from isaaclab.source.isaaclab.isaaclab.sim.utils.prims import _to_tuple  # type: ignore[reportPrivateUsage]
...
def test_to_tuple_precision():
    ...
    from isaaclab.source.isaaclab.isaaclab.sim.utils.prims import _to_tuple
