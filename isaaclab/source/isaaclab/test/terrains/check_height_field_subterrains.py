...
import isaaclab.source.isaaclab.isaaclab.terrains.height_field as hf_gen
from isaaclab.source.isaaclab.isaaclab.terrains.utils import color_meshes_by_height
