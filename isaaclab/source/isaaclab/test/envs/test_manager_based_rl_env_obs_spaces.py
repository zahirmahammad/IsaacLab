...
from isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.classic.cartpole.cartpole_camera_env_cfg import (
    CartpoleDepthCameraEnvCfg,
    CartpoleRGBCameraEnvCfg,
)
from isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.locomotion.velocity.config.anymal_c.rough_env_cfg import AnymalCRoughEnvCfg
...
def test_non_concatenated_obs_groups_contain_all_terms(device):
    ...
    """
    from isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.stack.config.franka.stack_joint_pos_env_cfg import (
