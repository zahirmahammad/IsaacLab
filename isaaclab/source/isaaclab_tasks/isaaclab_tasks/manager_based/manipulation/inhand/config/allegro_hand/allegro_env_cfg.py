...
import isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.inhand_env_cfg as inhand_env_cfg

##
# Pre-defined configs
##
from isaaclab.source.isaaclab_assets.isaaclab_assets import ALLEGRO_HAND_CFG  # isort: skip
