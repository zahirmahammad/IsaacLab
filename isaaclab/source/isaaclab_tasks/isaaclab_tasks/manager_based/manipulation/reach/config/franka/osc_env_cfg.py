...
from isaaclab.source.isaaclab.isaaclab.controllers.operational_space_cfg import OperationalSpaceControllerCfg
from isaaclab.source.isaaclab.isaaclab.envs.mdp.actions.actions_cfg import OperationalSpaceControllerActionCfg
