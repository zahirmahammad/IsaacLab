...
from isaaclab.source.isaaclab.isaaclab.devices.openxr.retargeters.humanoid.fourier.gr1t2_retargeter import GR1T2RetargeterCfg
...
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.fourier import GR1T2_HIGH_PD_CFG  # isort: skip
