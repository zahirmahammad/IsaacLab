...
from isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.locomotion.velocity.velocity_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg

##
# Pre-defined configs
##
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.cassie import CASSIE_CFG  # isort: skip
