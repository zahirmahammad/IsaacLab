...
from isaaclab.source.isaaclab_contrib.isaaclab_contrib.assets import Multirotor

if TYPE_CHECKING:
    from isaaclab.source.isaaclab.isaaclab.envs import ManagerBasedEnv, ManagerBasedRLEnv

from isaaclab.source.isaaclab.isaaclab.envs.utils.io_descriptors import generic_io_descriptor, record_shape
