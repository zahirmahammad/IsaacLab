...
from isaaclab.source.isaaclab_contrib.isaaclab_contrib.assets import MultirotorCfg

import isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.drone_arl.mdp as mdp
