...
from isaaclab.source.isaaclab.isaaclab.envs import DirectMARLEnv, DirectMARLEnvCfg
...
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.cart_double_pendulum import CART_DOUBLE_PENDULUM_CFG
