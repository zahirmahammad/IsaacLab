...
import isaaclab.source.isaaclab.isaaclab.sim.utils.prims as prim_utils
from isaaclab.source.isaaclab.isaaclab.sim import build_simulation_context

from isaaclab.source.isaaclab_contrib.isaaclab_contrib.assets import Multirotor, MultirotorCfg
...
# Pre-defined configs
##
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.arl_robot_1 import ARL_ROBOT_1_CFG
...
def test_multirotor_data_annotations():
    from isaaclab.source.isaaclab_contrib.isaaclab_contrib.assets.multirotor.multirotor_data import MultirotorData
