...
from isaaclab.source.isaaclab.isaaclab.envs.mimic_env_cfg import MimicEnvCfg
...
class InstructionDisplay:
    ...
    def __init__(self, xr: bool):
        ...
        if self.xr:
            from isaaclab.source.isaaclab.isaaclab.ui.xr_widgets import show_instruction
