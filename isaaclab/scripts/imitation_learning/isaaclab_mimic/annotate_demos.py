...
if args_cli.enable_pinocchio:
    import isaaclab.source.isaaclab_mimic.isaaclab_mimic.envs.pinocchio_envs  # noqa: F401

# Only enables inputs if this script is NOT headless mode
if not args_cli.headless and not os.environ.get("HEADLESS", 0):
    from isaaclab.source.isaaclab.isaaclab.devices import Se3Keyboard, Se3KeyboardCfg
...
from isaaclab.source.isaaclab.isaaclab.managers import RecorderTerm, RecorderTermCfg, TerminationTermCfg
