...
# Pre-defined configs
##
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.anymal import ANYMAL_B_CFG, ANYMAL_C_CFG, ANYMAL_D_CFG  # isort:skip
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.spot import SPOT_CFG  # isort:skip
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.unitree import UNITREE_A1_CFG, UNITREE_GO1_CFG, UNITREE_GO2_CFG  # isort:skip
