...
# Pre-defined configs
##
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.allegro import ALLEGRO_HAND_CFG  # isort:skip
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.shadow_hand import SHADOW_HAND_CFG  # isort:skip
