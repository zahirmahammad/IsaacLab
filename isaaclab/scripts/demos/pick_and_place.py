...
from isaaclab.source.isaaclab.isaaclab.markers import SPHERE_MARKER_CFG, VisualizationMarkers
...
from isaaclab.source.isaaclab_assets.isaaclab_assets.robots.pick_and_place import PICK_AND_PLACE_CFG
