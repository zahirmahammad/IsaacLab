...
from isaaclab.source.isaaclab.isaaclab.devices import Se3Keyboard, Se3KeyboardCfg, Se3SpaceMouse, Se3SpaceMouseCfg
from isaaclab.source.isaaclab.isaaclab.devices.openxr import remove_camera_configs
from isaaclab.source.isaaclab.isaaclab.devices.teleop_device_factory import create_teleop_device

import isaaclab.source.isaaclab_mimic.isaaclab_mimic.envs  # noqa: F401
from isaaclab.source.isaaclab_mimic.isaaclab_mimic.ui.instruction_display import InstructionDisplay, show_subtask_instructions

if args_cli.enable_pinocchio:
    import isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.locomanipulation.pick_place  # noqa: F401
    import isaaclab.source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.pick_place  # noqa: F401

from collections.abc import Callable

from isaaclab.source.isaaclab.isaaclab.envs import DirectRLEnvCfg, ManagerBasedRLEnvCfg
from isaaclab.source.isaaclab.isaaclab.envs.mdp.recorders.recorders_cfg import ActionStateRecorderManagerCfg
from isaaclab.source.isaaclab.isaaclab.envs.ui import EmptyWindow
from isaaclab.source.isaaclab.isaaclab.managers import DatasetExportMode

import isaaclab.source.isaaclab_tasks.isaaclab_tasks as isaaclab_tasks  # noqa: F401
from isaaclab.source.isaaclab_tasks.isaaclab_tasks.utils.parse_cfg import parse_env_cfg
...
def main() -> None:
    ...
    if args_cli.xr:
        rate_limiter = None
        from isaaclab.source.isaaclab.isaaclab.ui.xr_widgets import TeleopVisualizationManager, XRVisualization
